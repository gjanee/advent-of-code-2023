...
# like something we'd have, though - this is Island Island, after all!
# I bet the gardener would know.  He's on a different island, though -
# er, the small kind surrounded by water, not the floating kind.  We
# really need to come up with a better naming scheme.  Tell you what:
# if you can help me with something quick, I'll let you borrow my boat
# and you can go visit the gardener.  I got all these scratchcards as
...
for line in open("04.in"):
    winning, have = [set(s.split()) for s in line.split(":")[1].split("|")]
    num_wins.append(sum(n in winning for n in have))
